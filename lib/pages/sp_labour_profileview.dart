...
class _LabourpviewState extends State<Labourpview> {
  ...
  Future<Map<String, dynamic>?> getData() async {
    try {
      print('1');
      var result = await GetUsersData().getLabourInfo('$url/getLabourInfo');
      print(result);
      return result;
    } catch (err) {
      print(err.toString());
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  children:  [
                                                    ...
                                                    Text(
                                                      '${snapshot.data!['experience']} Year Experience',
                                                      style: const TextStyle(
                                                          fontSize: 20.0,
                                                          fontWeight: FontWeight.bold),
                                                    ),
    ...
    switch (item) {
      case 0:
        await Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => Editlabour(data!)),
        );
        setState(() {});
        break;
      /*case 1:
