                          ...
                          children: [
                            PopupMenuButton<int>(
                              ...
                              itemBuilder: (context) => [
                                ...
                                const PopupMenuItem<int>(
                                    value: 2, child: Text('Add your workshop photes')
                                )
                              ],
    ...
    switch (item) {
      case 0:
        await Navigator.push(
          context, MaterialPageRoute(builder: (context) => Edithdprofile(data!)),
        );
        setState(() {
      ...
      case 1:
        await Navigator.push(
          context, MaterialPageRoute(builder: (context) => Changehd_pw()),
        );
        break;
    }
  }
