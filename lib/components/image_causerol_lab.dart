...
class ImageCauserol_lab extends StatefulWidget {

  List<dynamic> tags;

  ImageCauserol_lab({Key? key, required this.tags})
      : super(key: key);

  @override
  State<ImageCauserol_lab> createState() =>
      // ignore: no_logic_in_create_state
  _ImageCauserol_labState(tags: tags);
}

class _ImageCauserol_labState extends State<ImageCauserol_lab> {
  int photo = 1;


  List<dynamic> tags;

  _ImageCauserol_labState({required this.tags});
            ...
            return Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>const Cslabourview()),
                  );
                },
